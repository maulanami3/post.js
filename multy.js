...
4. Setelah selesai dengan membuat postingan blog safelink, langkah selanjutnya membuat file JS untuk postingan yang tadi kalian buat dengan cara. Copy kode dibawah ini, buka notepad dan ganti https://buletblog.blogspot.com/2017/08/car-production-fall-hits-uk-industrial.html dengan url postingan yang kalian buat tadi.
...
if(x=="5"){xxx="/2018/10/safepost.5html"}a_to_ve[i].href="https://convert-safelink.blogspot.com"+xxx+"?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
var a_to_vj=document.getElementById("anonyminized");var a_to_vk=document.getElementById("found_links");if(a_to_vj)
{a_to_vj.innerHTML+=a_to_vb;}
if(a_to_vk)
{a_to_vk.innerHTML+=a_to_va;}}
